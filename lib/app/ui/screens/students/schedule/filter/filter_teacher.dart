...
class _FilterTeacherState extends State<FilterTeacher> {
  ...
  void initState() {
    setState(() {
      selected = context.read<StudentScheduleState>().filterSchedule.teacher;
    });
    super.initState();
  }
  ...
  void addAll() {
    final listTeacher = context.read<StudentScheduleState>().listTeacher;
  ...
  void apply() {
    context.read<StudentScheduleState>().changeFilterTeacher(selected);
