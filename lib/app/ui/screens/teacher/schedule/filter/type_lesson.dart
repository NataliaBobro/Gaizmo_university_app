...
class _TypeLessonState extends State<TypeLesson> {
  ...
  void initState() {
    setState(() {
      selected = context.read<TeacherScheduleState>().filterSchedule.type;
    });
    super.initState();
  }
  ...
  void addAll() {
    final listTypeServices = context.read<TeacherScheduleState>().listTypeServices;
  ...
  void apply() {
    context.read<TeacherScheduleState>().changeFilterType(selected);
