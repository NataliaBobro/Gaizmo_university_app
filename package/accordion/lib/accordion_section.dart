  ...
  build(context) {
    ...
    return Slidable(
      ...
      endActionPane: ActionPane(
        extentRatio: isFullActionButton ? (onEdit != null && onDelete != null ? 0.4 : 0.2) : 0.2,
        ...
        children: [
          Column(
            children: [
              SizedBox(
                height: 43,
                width: isFullActionButton ? (onEdit != null && onDelete != null ? 142 : 72) : 72,
                child: Row(
                  ...
                  children: [
                    if(onEdit != null) ...[
                      CupertinoButton(
                          ...
                          minSize: 0.0,
                          child: Container(
                            width: isFullActionButton ? 64 : 32,
